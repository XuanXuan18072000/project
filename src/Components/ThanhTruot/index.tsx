...
export default function SlideBar() {
  ...
  slidebars.forEach( (slidebar:any) => {
    ...
    slidebar.onclick = function () {
       ...
       let items = document.querySelector<HTMLElement>('.slibarDetailItem.activeThanhTruot')!
            items.classList.remove('activeThanhTruot')
        
        this.classList.add('activeThanhTruot')
    ...
    return (
        <div className="SlideBar">
              <div className="ThanhTruotIMG">
                  <img src={logo}/>
              </div>
              <div className="slibarDetail">
                  <Link to="/dashboard">
                        <div className="slibarDetailItem activeThanhTruot">
