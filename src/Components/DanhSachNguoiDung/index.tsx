...
import {fetchDataChart} from '../../redux/DatAlta/DataAltaActions'
 ...
 function DanhSachNguoiDung({dataTableRedux,fetchDataChart}:any) {
...
//     ]
        ...
        const dataDanhSachNguoiDung = dataTableRedux.dataDanhSachNguoiDung
    
        const [data,setData] = useState(dataDanhSachNguoiDung)
        ...
        <div className="ServiceTableDetailItem" key={index}>
            ...
            <div className="ServiceTableDetailTitles_Item">
                    ...
                    <span>
                            {item.state== 'Hoạt động' ? <ServiceActivePoint value={'Hoạt động'}/> : <ServiceUnactivePoint value={'Ngưng hoạt động'}/>} 
  ...
  return <div className="DanhSachNguoiDung">
            ...
            <div className="DanhSachNguoiDung__container">
