...
import {fetchDataChart,SENDDATA} from '../../redux/DatAlta/DataAltaActions'
 ...
 function CapSo( {dataTableRedux,fetchDataChart,SENDDATA}:any) {
        ...
        const dataCapSo = dataTableRedux.dataCapSo
        ...
        const [data,setData] = useState(dataCapSo)
    ...
    'Tất cả', 'Kiosk', 'Hệ thống'
       ...
       /////
        ...
        const handleDropdownValue = (e:any)=>{
                ...
                // e.value == 'Đang chờ' && setData(dataCapSoWait)
                // e.value == 'Đã sử dụng' && setData(dataCapSoUsed)
                // e.value == 'Bỏ qua' && setData(dataCapSoUnActive)
                // e.value == 'Tất cả' && setData(dataCapSo)
...
const mapStateToProps = (state:any) =>{
      ...
      export default connect(mapStateToProps,mapDispatchToProps)(CapSo)
