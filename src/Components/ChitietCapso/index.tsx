...
import {fetchDataChart,SENDDATA} from '../../redux/DatAlta/DataAltaActions'
 ...
 function ChitietCapso({dataTableRedux,fetchDataChart,SENDDATA}:any) {
  ...
  return <div className="ChitietCapso">
                ...
                <div className="ChitietCapso__container">
                    <div className="ChitietCapso__container__title">
                        Thông tin cấp số
                    </div>
                    <div className="ChitietCapso__container__list">
                        <div className="ChitietCapso__container__items">

                                <div className="ChitietCapso__container__item">
                                        <span>Họ tên:</span>
...
const mapStateToProps = (state:any) =>{
      ...
      export default connect(mapStateToProps,mapDispatchToProps)(ChitietCapso)
