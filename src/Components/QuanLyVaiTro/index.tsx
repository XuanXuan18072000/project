...
import {fetchDataChart,SENDDATAROLEMANAGEMENT} from '../../redux/DatAlta/DataAltaActions'



 function QuanLyVaiTro( {dataTableRedux,fetchDataChart,SENDDATAROLEMANAGEMENT}:any ) {
  ...
  const dataRoleTableDetail = dataTableRedux.dataRole
  ...
  const handleSend = (data:any) => {
    ...
    return (
        <div className="QuanLyVaiTro">
            ...
            <div className="QuanLyVaiTro__Talbe">
                ...
                <div className="QuanLyVaiTro__Talbe__data">
...
const mapStateToProps = (state:any) =>{
      ...
      export default connect(mapStateToProps,mapDispatchToProps)(QuanLyVaiTro)
