...
import {fetchDataChart} from '../../redux/DatAlta/DataAltaActions'
 ...
 function BaoCao({dataTableRedux,fetchDataChart}:any) {
...
const data1 = [
 ...
 },
 {
    ...
    const data = dataTableRedux.dataBaoCao

    const [ dataBaoCao , setDataBaoCao] = useState(data)
...
//        return   <div className="BaoCao__checkboxs"> 
//                         <span  className="BaoCao__checkboxs__span">{value}</span>  
//                         <input  className="BaoCao__checkboxs__input" type="checkbox" />
//                  </div>
//    }
   ...
   const optionsProduct = ['Tất cả' , 'Kiosk','Hệ thống']
    ...
    const dataBeforDisplay = dataBaoCao.slice( pagesVisited , pagesVisited + dataPerPage )
  ...
  return <div className="BaoCao">
                ...
                <div className="BaoCao__DatePicker">
                                <DatePicker selected={startDate} onChange={(date) => setStartDate(date)} />
                                         
                                         <div className="BaoCao__DatePicker__icon"><img src={Vector} alt="" /> </div>
                                
                                <DatePicker selected={startDate} onChange={(date) => setStartDate(date)} />
                </div>

                <div className="BaoCao__container">
            ...
            <div className="ServiceTableDetail">
                ...
                <div className="ServiceTableDetailTitles">
                        <div className="ServiceTableDetailTitles_Item">
                            <div className="BaoCao__container__dropdown">
                        ...
                        <div className="ServiceTableDetailTitles_Item">
                            <div className="BaoCao__container__dropdown BaoCao__container__dropdown--service">
                        ...
                        {
                        //     dataBaoCao.map( (item:any,index:any)=>
