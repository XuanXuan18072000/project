...
function ChitietDichVu({dataTableRedux,fetchDataChart}:any) {
   ...
   const optionsConnect = [
    'Tất cả', 'Kết nối', 'Mất kết nối'
     ...
     const defaultOptionConnect = optionsConnect[0];
        ...
        <div className="ChitietDichVu__container__table__detail__infor" key={index}>
                <div className="ChitietDichVu__container__table__detail__title__item">
    ...
    return (
        <div className="ChitietDichVu">
                ...
                <div className="ChitietDichVu_title">
                     Quản lý dịch vụ
                </div>
                <div className="ChitietDichVu__container">

                        <div className="ChitietDichVu__container_items">
                            <div className="ChitietDichVu__container_items__item">
                                <div className="ChitietDichVu__container_items__item__title">
                                    Thông tin dịch vụ
                                </div>
                                <div className="ChitietDichVu__container_items__item_1">
                            ...
                            <div className="ChitietDichVu__container_items__item">
                                ...
                                <div className="ChitietDichVu__container_items__item_1">
                                        ...
                                        <div className="ChitietDichVu__container_items__item_1__inputs">
                        ...
                        <div className="ChitietDichVu__container__table">
                    ...
                    <div className="ServiceDropdownsSarchFirst  ServiceDropdownsSarchFirst_input">
                            <div className="ServiceDropdownsSarchFirstName choseKey ServiceDropdownsSarchFirstName--ChitietDichVu">Từ khóa</div>
                                <div className="ServiceDropdowns_input ServiceDropdowns_input--ChitietDichVu">
                                ...
                                <div className="ChitietDichVu__container__table__detail">

                                    <div className="ChitietDichVu__container__table__detail__title">
                                            <div className="ChitietDichVu__container__table__detail__title__item">
                                                    <span>Số thứ tự</span>
                                            </div>
                                            <div className="ChitietDichVu__container__table__detail__title__item">
...
const mapStateToProps = (state:any) =>{
      ...
      export default connect(mapStateToProps,mapDispatchToProps)(ChitietDichVu)
