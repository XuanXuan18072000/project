...
import {fetchDataChart} from '../../redux/DatAlta/DataAltaActions'
 ...
 function NhatKyNguoiDung({dataTableRedux,fetchDataChart}:any) {
...
},
{
    ...
    const dataNhatKyNguoiDung = dataTableRedux.dataNhatKyNguoiDung

    const [data,setData]  = useState(dataNhatKyNguoiDung)
    ...
    return (
        <div className="NhatKyNguoiDung">
                ...
                <div className="NhatKyNguoiDung__Table">
                ...
                <div className="ServiceDropdownsSarch">
                 ...
                 <div className="NhatKyNguoiDung_Table_Data">
...
const mapStateToProps = (state:any) =>{
  ...
  export default connect(mapStateToProps,mapDispatchToProps)(NhatKyNguoiDung)
