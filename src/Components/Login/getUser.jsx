...
function GetUser() {
    ...
    const [ gotoNewpassword , setGotoNewpassword] = useState(true)

    const emails = valueFirebase.map ( (data)=>{
            return data.email
    })
       ...
       const handleCheckEmail = () =>{
            emails.includes(email) ? setGotoNewpassword(true) : setGotoNewpassword(true)
        }
